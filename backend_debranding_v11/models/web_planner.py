...
class Planner(models.Model):
    ...
    def render(self, template_id, planner_app):
        ...
        new_company = self.env['ir.config_parameter'].sudo().get_debranding_parameters().get('backend_debranding_v11.new_name')
        planner_footer = self.env['ir.config_parameter'].sudo().get_debranding_parameters().get('backend_debranding_v11.planner_footer')
